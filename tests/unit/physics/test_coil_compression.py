...
def test_canary_estimate_compression_matrix():
    ...
    from spectramr.infrastructure.physics.coil_compression import estimate_compression_matrix
...
def test_canary_svd_compressor():
    ...
    from spectramr.infrastructure.physics.coil_compression import SVDCoilCompressor
    ks = _kspace(1, 8, 32, 32)
...
def test_apply_matrix_raises_coil_mismatch():
    ...
    from spectramr.infrastructure.physics.coil_compression import apply_compression_matrix
    ks = _kspace(1, 8, 16, 16)
