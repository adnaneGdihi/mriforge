...
# is re-exported here for the historical ``spectramr.accelerator.seed_worker``
# import path.
__all__ = ["seed_worker"]
...
def initialize_accelerator(
    ...
    *,
    ...
    :mod:`spectramr.core.compute_device`: a heavy pipeline that cannot get an
    ...
    # multi-GPU path (`torchrun -m spectramr.cli train-distributed` never imports
