...
for all available discriminator model types in the spectraMR framework.

Usage:
    from spectramr.models.factories.discriminator_types import DiscriminatorTypes
...
class DiscriminatorTypes:
    """Registry of all available discriminator model types in spectraMR.
