...
primitive :mod:`spectramr.infrastructure.physics.causal_frontdoor` so that the
...
#. a **front-door consistency** residual between the prediction's
   ...
   through :func:`~spectramr.infrastructure.physics.causal_frontdoor.frontdoor_adjusted_prediction`;
