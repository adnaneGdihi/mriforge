...
:mod:`spectramr.models.diffusion.stochastic_resetting`:
...
2. **Reset-consistency term** — applies one Bernoulli
   :func:`~spectramr.models.diffusion.stochastic_resetting.apply_resetting`
...
3. **MFPT term** — penalises the mean-first-passage-time
   :func:`~spectramr.models.diffusion.stochastic_resetting.mfpt_with_resetting`
