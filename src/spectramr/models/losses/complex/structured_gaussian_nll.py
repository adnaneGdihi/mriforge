...
matrix-free through
:class:`spectramr.infrastructure.physics.structured_covariance.StructuredCovariance`
...
from spectramr.infrastructure.physics.structured_covariance import StructuredCovariance
