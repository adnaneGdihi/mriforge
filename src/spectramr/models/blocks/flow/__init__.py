...
- :class:`~spectramr.models.blocks.flow.actnorm.ActNorm2d`
- :class:`~spectramr.models.blocks.flow.invertible_1x1_conv.InvertibleConv1x1LU`
- :class:`~spectramr.models.blocks.flow.affine_coupling.AffineCoupling`
- :class:`~spectramr.models.blocks.flow.squeeze.Squeeze2x`,
  :class:`~spectramr.models.blocks.flow.squeeze.Split`
