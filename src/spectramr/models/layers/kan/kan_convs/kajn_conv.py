...
class KAJNConvNDLayer(nn.Module):
    ...
    def compute_jacobi_polynomials(self, x, order):
        ...
        for i in range(2, order + 1):
            ...
            pn = (theta_k * x + theta_k1) * jacobi_polys[i - 1].clone() - theta_k2 * jacobi_polys[
                i - 2
            ].clone()
    ...
    def forward(self, x):
        ...
        forward method for KAJNConvNDLayer.
