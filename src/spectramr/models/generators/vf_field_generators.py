...
from spectramr.infrastructure.physics.multi_acquisition import invert_bssfp_banding
...
class GraphCutUnwrapGenerator(_Task3Mixin, IGenerator, nn.Module):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        from spectramr.models.topological.graph_cuts_neural import DifferentiableGraphModule
