...
(:class:`~spectramr.models.blocks.field_film_modulation.FieldFiLMBlock`, zero-init -> identity
start). The B-1.3 contribution is the scattering+Besov DETAIL LOSS
(:class:`~spectramr.models.losses.scattering_besov_loss.ScatteringBesovLoss`); this backbone is the
