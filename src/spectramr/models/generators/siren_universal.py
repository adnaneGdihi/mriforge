...
:class:`~spectramr.models.generators.siren_generator.SIRENGenerator`. The
...
from spectramr.models.blocks.acquisition_conditioning import (
    AcquisitionEmbedding,
    sinusoidal_positional_encode,
)
from spectramr.models.generators.siren_generator import SirenLayer
