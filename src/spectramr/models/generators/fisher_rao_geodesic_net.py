...
``x_t = cos^2(arccos(sqrt(x)) + delta)`` (:mod:`spectramr.models.blocks.fisher_rao_sphere`),
...
trainability/ablation-conditioning caveat documented in :mod:`spectramr.models.blocks.fisher_rao_sphere`.
...
from spectramr.models.blocks.fisher_rao_sphere import fisher_rao_geodesic_step
