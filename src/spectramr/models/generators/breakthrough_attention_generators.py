...
:mod:`spectramr.models.blocks` and is mathematically self-contained, but a block
...
from spectramr.models.blocks.tjl_hash_attention import TJLHashAttention
from spectramr.models.blocks.toeplitz_attention import ToeplitzSpectralAttention
