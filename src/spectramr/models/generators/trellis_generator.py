...
Adapted for spectraMR project following SOLID principles.
"""
...
from spectramr.models.blocks.adapters import (
    DecoderAdapter3D,
    LatentGridSpec,
    SpatialResizer3D,
)
...
from spectramr.models.representations.slat.renderers import (
