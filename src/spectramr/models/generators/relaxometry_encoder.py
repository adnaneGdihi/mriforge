...
:func:`~spectramr.infrastructure.physics.dispersion.power_law_t1_transport`
(``T1(B0)=T1_ref (B0/B0_ref)^beta``), and re-evaluates the differentiable SPGR signal
equation :func:`~spectramr.models.blocks.spgr_signal.spgr_signal` at the target field.
