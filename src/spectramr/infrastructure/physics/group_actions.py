...
:class:`spectramr.infrastructure.training.strategies.equivariant_imaging_strategy.EquivariantImagingStrategy`.
...
(:func:`spectramr.infrastructure.physics.fft_ops.fft2c` / ``ifft2c``).
"""
