...
factory (``spectramr.infrastructure.inference.inference_factory``) can engage the
SPECTRA backend with a single guard at the top of ``create``::

    from spectramr.infrastructure.accelerator.spectra import get_spectra_executor
