...
in :mod:`spectramr.infrastructure.training.scheduler_system`. Per the repo's
...
def _register_builtin_optimizers() -> None:
    ...
    """
    from spectramr.infrastructure.training import optimizers as _optimizers  # noqa: F401
...
def _assert_registry_covers_the_advertised_vocabulary() -> None:
    ...
    if missing:
        raise ImportError(
            ...
            "spectramr/infrastructure/training/optimizers/__init__.py, or remove the "
            "enum member."
        )
