...
:class:`~spectramr.infrastructure.training.builders.environment.TrainingEnvironment`
...
class LoopState:
    ...
    Attributes:
        ...
        loss_weight_overrides: Dynamic ``{loss_term: weight}`` overrides written
            by :class:`~spectramr.infrastructure.training.loss_schedule_controller.LossScheduleController`
