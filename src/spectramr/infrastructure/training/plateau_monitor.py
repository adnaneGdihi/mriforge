...
* :class:`~spectramr.infrastructure.services.early_stopping.EarlyStoppingService`,
  which stops training on a plateau, and
* :class:`~spectramr.infrastructure.training.loss_schedule_controller.LossScheduleController`,
