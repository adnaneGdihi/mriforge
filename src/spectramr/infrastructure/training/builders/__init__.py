...
training environments in spectraMR. The pattern eliminates 1,200+ lines
...
Example:
    >>> from spectramr.infrastructure.training.builders import TrainingEnvironmentDirector
