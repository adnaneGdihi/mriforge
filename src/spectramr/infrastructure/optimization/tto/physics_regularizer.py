...
from spectramr.infrastructure.optimization.regularizers.divergence import (
    DivergenceFreeRegularizer,
)
from spectramr.infrastructure.optimization.regularizers.knn_graph import KNNGraphRegularizer
