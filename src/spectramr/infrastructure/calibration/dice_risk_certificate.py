...
class DiceRiskReport:
    ...
    #: What one draw was (``subject`` or ``sample``) and how many images were
    #: scored to form the ``n`` draws; ``n`` is the count the bound used.
    independence_unit: str = "sample"
    ...
    def certify(
        ...
        *,
        ...
        return DiceRiskReport(
            ...
            independence_unit=str(independence_unit),
            n_samples_scored=None if n_samples_scored is None else int(n_samples_scored),
