...
:mod:`spectramr.infrastructure.calibration.scores`; it exists so YAMLs
...
from spectramr.infrastructure.calibration.scores import (  # noqa: E402, I001  (intentional late import)
