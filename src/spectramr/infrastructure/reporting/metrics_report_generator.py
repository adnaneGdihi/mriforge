...
class MetricsReportGenerator:
    ...
    def _plot_losses(self) -> None:
        if self.df is None:
            return
        from spectramr.infrastructure.reporting._training_curves import plot_training_curves
    ...
    def _plot_psnr_ssim_composite(
        ...
        for ax, cols, ylabel, title, hib in (
            ...
            for i, col in enumerate(cols):
                ...
                from spectramr.infrastructure.reporting._training_curves import ema
