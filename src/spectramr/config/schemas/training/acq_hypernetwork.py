...
(:class:`~spectramr.infrastructure.training.strategies.hypernetwork_strategy.AcquisitionHypernetworkStrategy`)
trains :class:`~spectramr.models.encoders.lcah_encoder.LCAHEncoder` -- a
