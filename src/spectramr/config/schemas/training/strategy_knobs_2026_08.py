...
:mod:`spectramr.config.schemas.training.strategy_knobs_2026_06`, whose docstring
...
:class:`~spectramr.config.schemas.training.base.TrainingStrategyConfigSchema` is
