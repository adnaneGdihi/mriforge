...
measurement?" using the :class:`~spectramr.core.metrics.context.MetricContext`
...
* ``fmed`` — Forward-Model Equivariance Defect. RMS commutator of
  ...
  :func:`spectramr.core.metrics.equivariance_defect.equivariance_defect_score`.
...
def _to_mag_image(x: Tensor) -> Tensor:
    ...
    Mirrors :func:`spectramr.core.metrics.hallucination_metrics._to_magnitude`
