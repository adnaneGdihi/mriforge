...
class VolumeConsistencyMetric:
    ...
    the cluster, :class:`~spectramr.core.metrics.quantitative.segmentation.LabelDiceBackend`
    ...
    def score_from_segmenters(
        ...
        :class:`~spectramr.core.metrics.quantitative.segmentation.ISegmenter`
    ...
    def __call__(
        ...
        **kwargs: object,
        ...
        if seg is None:
            from spectramr.core.metrics.quantitative.segmentation import get_segmenter
