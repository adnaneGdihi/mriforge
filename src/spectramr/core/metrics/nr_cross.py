...
sibling / prior bundle from a :class:`~spectramr.core.metrics.context.MetricContext`.
...
class BlochReSynthesisConsistency:
    ...
    (:class:`~spectramr.infrastructure.physics.differentiable_bloch.DifferentiableBlochLayer`),
