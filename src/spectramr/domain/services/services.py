#!/usr/bin/env python
"""Domain Services
Business logic services for the spectraMR system.
...
from spectramr.infrastructure.services import IDeviceService
from spectramr.models.interfaces.models import IDiscriminator, IGenerator
