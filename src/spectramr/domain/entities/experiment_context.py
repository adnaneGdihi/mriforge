...
A single :func:`spectramr.infrastructure.validation.context_resolver.resolve`
...
:mod:`spectramr.models.capabilities` and are reused verbatim here so there is **one**
