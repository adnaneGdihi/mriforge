...
class TrainingSessionEntity:
    """Domain entity representing a training session in the spectraMR system.
...
class ExperimentEntity:
    """Domain entity representing an experiment in the spectraMR system.
...
class ValidationResultEntity:
    """Domain entity representing validation results in the spectraMR system.
...
class DomainEvent:
    """Base class for domain events in the spectraMR system.
...
class TrainingStartedEvent(DomainEvent):
    """Event fired when a training session starts in the spectraMR system.
...
class TrainingCompletedEvent(DomainEvent):
    """Event fired when a training session completes in the spectraMR system.
...
class ModelValidatedEvent(DomainEvent):
    """Event fired when model validation occurs in the spectraMR system.
