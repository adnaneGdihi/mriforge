...
SNR boost, and :func:`~spectramr.infrastructure.physics.m4raw_pseudo_gt.synthesize_pseudo_gt`
...
from spectramr.data.regions.region_registry import REGION_SPECS, RegionTier
