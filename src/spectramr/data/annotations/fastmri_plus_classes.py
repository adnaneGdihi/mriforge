...
:meth:`~spectramr.data.annotations.fastmri_plus.AnnotationParseReport.raise_if_unmapped`
...
:mod:`spectramr.data.sources.fastmri_brain_source`). Measurement separates the craniotomy
...
class UnmappedLabelError(KeyError):
    ...
    def __init__(self, label: str) -> None:
        ...
        super().__init__(
            ...
            "spectramr/data/annotations/fastmri_plus_classes.py. There is deliberately "
            "no 'other' bucket."
        )
