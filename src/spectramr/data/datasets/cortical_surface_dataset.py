...
from spectramr.data.datasets.fmri_volume_dataset import FMRIVolumeDataset
...
class CorticalSurfaceDataset(Dataset):
    ...
    consumes it via the
    :func:`spectramr.data.transforms.sfc_conformal_fmri_keys.attach_cortex_flatten_grid`
    transform.
    """
