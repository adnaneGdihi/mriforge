#!/usr/bin/env python3
"""Hyperparameter Tuning Tool for spectraMR.

This script runs a hyperparameter search using Optuna.
Usage:
    python -m spectramr.tools.tune --config experiments/configs/base_config.yaml --trials 10
"""
...
from spectramr.models.tuning import HyperparameterTuner
...
def main() -> None:
    ...
    tuner = HyperparameterTuner(
        ...
        study_name="spectramr_optimization",
