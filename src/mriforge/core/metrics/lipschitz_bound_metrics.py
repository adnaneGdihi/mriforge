...
(:class:`~mriforge.core.metrics.nr_stability.LocalReconstructionJacobianSpectralNorm`)
...
(precedent:
:class:`~mriforge.core.metrics.robustness_metrics.AdversarialPSNRDropMetric`),
