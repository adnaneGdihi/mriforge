...
:mod:`mriforge.infrastructure.physics.band_partition`) and reports the transfer
gain
...
:class:`~mriforge.infrastructure.training.strategies.multi_acquisition_strategy.ConcreteMultiAcquisitionStrategy`
puts it to.
...
from mriforge.infrastructure.physics.band_partition import (
    acquisition_rho,
    band_edges,
    band_masks,
    band_transfer,
...
class SuperNyquistFidelity:
    ...
    :func:`~mriforge.infrastructure.physics.band_partition.acquisition_rho`:
        ...
        **kwargs: Any,  # absorb device= etc. from InfrastructureBuilder
        ...
        Args:
            ...
            min_bins: Smallest admissible band population; see
                :func:`~mriforge.infrastructure.physics.band_partition.band_masks`.
        """
