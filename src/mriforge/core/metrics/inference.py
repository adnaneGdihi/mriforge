...
from mriforge.core.metrics.evaluation_metrics import FID, IS, PSNR
from mriforge.core.metrics.evaluation_metrics import SSIMMetric as SSIM
...
class ParadigmSpecificEvaluator:
    ...
    def evaluate(
        ...
        if real is not None:
            try:
                from mriforge.core.metrics import compute_metric
