...
def _build_policy_table() -> dict[str, RoiPolicy]:
    ...
    from mriforge.core.metrics.registry import MetricsRegistry, list_available
...
def policy_table() -> dict[str, RoiPolicy]:
    ...
    **Deliberately not a module-level constant.** It used to be
    ...
    that was still filling. ``mriforge/core/metrics/__init__.py`` imports this package
