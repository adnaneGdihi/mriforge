...
Entry point: :func:`~mriforge.core.metrics.regions.scorer.score_region`.
Read :mod:`~mriforge.core.metrics.regions.eligibility` first -- it is the gate.
"""

from mriforge.core.metrics.regions.crop import crop_to_region
from mriforge.core.metrics.regions.eligibility import (
    ROI_POLICY,
    Eligibility,
    Normalisation,
    RoiPolicy,
...
from mriforge.core.metrics.regions.reductions import (
    MAP_REDUCERS,
    MapReducer,
    masked_mean,
)
from mriforge.core.metrics.regions.scorer import (
    eligibility_table,
    score_region,
    score_region_set,
)
from mriforge.core.metrics.regions.types import (
    FULL_REGION_ID,
    RegionMask,
    RegionSet,
    RegionSource,
