...
# ``mriforge.core.metrics.context``: a plain class with ``__call__(self,
...
class PowerSpectrumDecayConformity:
    ...
    :class:`~mriforge.core.metrics.evaluation_metrics.PowerSpectrumConsistency`'s
    radial profile and :func:`~mriforge.infrastructure.physics.fft_ops.fft2c`.
...
class KSpaceSpikeKurtosis:
    ...
    injected. Reuses :func:`~mriforge.infrastructure.physics.fft_ops.fft2c`.
    """
...
class ContrastInvariantEdgeAcutance:
    ...
    step height. Uses :class:`~mriforge.models.losses.edge_detection.SobelOperator`
    ...
    def __call__(
        ...
        **kwargs: object,
        ...
        from mriforge.models.losses.edge_detection import SobelOperator
...
class HighFrequencyResidualWhiteness:
    ...
    :func:`~mriforge.models.losses.high_frequency_residual_loss._gaussian_lowpass`
    and :func:`~mriforge.infrastructure.physics.fft_ops.fft2c`.
...
class QuantitativeVarianceToCRLBRatio:
    ...
    Reuses :class:`~mriforge.infrastructure.physics.differentiable_bloch.DifferentiableBlochLayer`.
    """
