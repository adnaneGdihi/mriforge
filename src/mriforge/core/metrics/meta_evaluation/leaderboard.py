...
* :func:`~mriforge.core.metrics.meta_evaluation.aggregation.aggregate` -- the
  z-weighted cross-ranker combiner, per cell.
* :func:`~mriforge.core.metrics.meta_evaluation.powered.certify_partial_order` --
  the Hoeffding-bounded pairwise gate, which is what turns "top 5" into an honest
  claim.
* :func:`~mriforge.core.metrics.meta_evaluation.aggregation.kemeny_consensus` --
...
from mriforge.core.metrics.meta_evaluation.powered import certify_partial_order
