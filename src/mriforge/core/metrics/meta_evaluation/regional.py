...
it needs already existed -- :mod:`mriforge.core.metrics.regions` scores a metric on a
...
from mriforge.core.metrics.outcome import MetricStatus
from mriforge.core.metrics.regions.eligibility import Eligibility, evaluate_eligibility
from mriforge.core.metrics.regions.scorer import score_region
from mriforge.core.metrics.regions.types import FULL_REGION_ID, RegionMask, RegionSet
    ...
    *,
    ...
    Args:
        ...
        regions: ``content_id -> RegionSet``. Regions are computed on the CLEAN
            reference (see :mod:`mriforge.core.metrics.regions.types`), so one set per
