...
(:func:`mriforge.infrastructure.reporting.aggregator.aggregate`) — the
...
from mriforge.infrastructure.reporting.plotters import get as get_plotter
...
def generate_task_ablation_figures(
    ...
    *,
    ...
    try:
        from mriforge.infrastructure.reporting.metadata import detect_metadata
...
def merge_baseline_results(
    ...
    *,
    ...
    :func:`mriforge.pipelines.eval_baselines.run_baseline_evaluation`.
    """
    task_int = int(task)
