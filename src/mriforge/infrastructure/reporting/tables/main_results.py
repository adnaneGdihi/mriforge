...
def _holm_correction(pvals: list[float]) -> list[float]:
    ...
    (:meth:`mriforge.core.metrics.statistical_tests.StatisticalTests.holm_bonferroni_correction`).
...
def make(
    ...
    *,
    ...
    from mriforge.infrastructure.reporting.tables import emit_table_csv
