...
four interleaved copies of the same four lines::
    ...
    ⏳ mriforge train-distributed: importing PyTorch + model registry ...   x4
    Cache root from TMPDIR: /tmp/.../mriforge_cache                          x4
    [Parallel] process-group backend=nccl (source=config)                  x4
    UserWarning: MRIForge is research software and is NOT FOR CLINICAL USE   x4
