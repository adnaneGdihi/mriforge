...
All metric computation delegates to mriforge.core.metrics (SSOT).
"""
...
from mriforge.core.metrics import compute_metric, list_available
...
def _metric_higher_is_better(key: str) -> bool | None:
    ...
    (:func:`mriforge.core.metrics.metric_directions.resolve_direction`) because
...
class MetricsTracker(IMetricsService):
    ...
    Delegates all metric computation to mriforge.core.metrics (SSOT) registry.
    Handles:
