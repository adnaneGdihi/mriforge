...
early-stopping path (:mod:`mriforge.pipelines.train`) and the loss-schedule
controller (:mod:`mriforge.infrastructure.training.loss_schedule_controller`)
...
``mriforge.pipelines.train`` re-exports :func:`early_stop_monitor_candidates`
