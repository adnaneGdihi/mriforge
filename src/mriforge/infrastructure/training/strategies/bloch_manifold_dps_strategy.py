...
:class:`~mriforge.models.diffusion.bloch_manifold_dps_sampler.BlochManifoldDPSSampler`
...
from mriforge.infrastructure.training.strategies.mixins.utils import _callable_accepts_kwarg
