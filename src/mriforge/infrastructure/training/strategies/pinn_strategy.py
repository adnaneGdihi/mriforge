...
from mriforge.models.generators.siren_pinn import SirenSensNet, get_last_shared_layer
...
class ConcretePINNSensitivityStrategy(BaseTrainingStrategy):
    ...
    def _compute_losses_impl(
        ...
        **kwargs: Any,
        ...
        from mriforge.infrastructure.physics.fft_ops import _to_complex, fft2c, ifft2c
