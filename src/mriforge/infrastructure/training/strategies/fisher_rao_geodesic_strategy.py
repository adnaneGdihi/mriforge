...
Trains a :class:`~mriforge.models.generators.fisher_rao_geodesic_net.FisherRaoGeodesicNet` to
...
class FisherRaoGeodesicStrategy(ReconstructionTrainingStrategy):
    ...
    def _setup_strategy_specific_components(self) -> None:
        ...
        self._fr_lambda_l1 = float(getattr(cfg, "lambda_l1", 1.0)) if cfg is not None else 1.0
