...
(:mod:`mriforge.core.metrics.equivariance_defect`) per calibration sample over
...
``mriforge/infrastructure/training/strategy_factory.py::STRATEGY_CLASS_PATHS``::

    "equivariance_conformal": (
        "mriforge.infrastructure.training.strategies.equivariance_conformal_strategy."
