...
Trains a :class:`~mriforge.models.generators.mccann_geodesic_icnn.McCannGeodesicICNN` (one
...
class McCannFieldPathStrategy(ReconstructionTrainingStrategy):
    ...
    def _setup_strategy_specific_components(self) -> None:
        ...
        self._mc_lambda_l1 = float(getattr(cfg, "lambda_l1", 1.0)) if cfg is not None else 1.0
