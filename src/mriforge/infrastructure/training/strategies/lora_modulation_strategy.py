...
Trains a :class:`~mriforge.models.generators.lora_modulation_net.LoRAModulationNet` (a shared
...
class LoRAModulationStrategy(ReconstructionTrainingStrategy):
    ...
    def _setup_strategy_specific_components(self) -> None:
        ...
        self._lm_lambda_l1 = float(getattr(cfg, "lambda_l1", 1.0)) if cfg is not None else 1.0
