...
Trains a :class:`~mriforge.models.generators.koopman_field_propagator.KoopmanFieldPropagator`
...
from mriforge.infrastructure.physics.koopman_operator import koopman_numerical_abscissa
...
class KoopmanFieldStrategy(ReconstructionTrainingStrategy):
    ...
    def _setup_strategy_specific_components(self) -> None:
        ...
        self._kf_lambda_l1 = float(getattr(cfg, "lambda_l1", 1.0)) if cfg is not None else 1.0
