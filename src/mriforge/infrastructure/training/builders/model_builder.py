...
from mriforge.infrastructure.optimization.ema import ModelEma  # [FIX] Added for EMA
...
class ModelBuilder(Builder):
    ...
    def build_generator(self) -> "ModelBuilder":
        ...
        :func:`~mriforge.infrastructure.builders.generator_kwargs.resolve_generator_kwargs`
