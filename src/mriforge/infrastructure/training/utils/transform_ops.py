...
class ReconstructionUtilities:
    ...
    def _normalize_image(self, image: torch.Tensor) -> torch.Tensor:
        ...
        ``mriforge.data.transforms.normalization``.
        ...
        Returns:
            Normalized image
        """
        from mriforge.data.transforms.normalization import normalize_minmax
...
def create_fft_transformer(device: torch.device | None = None) -> FFTTransformer:
    ...
    the unified FFT operations from mriforge.infrastructure.physics.fft_ops.
...
def create_complex_handler() -> ComplexTensorHandler:
    ...
    NOTE: This now serves as a compatibility layer that uses
    the unified complex operations from mriforge.infrastructure.physics.fft_ops.
...
def create_reconstruction_utilities(
    ...
    NOTE: This now serves as a compatibility layer that uses
    the unified operations from mriforge.infrastructure.physics.fft_ops.
