...
.. deprecated:: Phase 2 Migration
   Use :class:`mriforge.infrastructure.training.builders.environment.TrainingEnvironment` instead.
...
# from mriforge.shared.utils.ema import ExponentialMovingAverage
...
class TrainingState(ITrainingState):
    ...
    .. deprecated:: Phase 2 Migration
       ...
       mriforge.infrastructure.training.builders.environment instead.
    ...
    stability_manager: Any  # mriforge.models.stability.StabilityManager
    ...
    def __post_init__(self):
        ...
        warnings.warn(
            ...
            "Use TrainingEnvironment from mriforge.infrastructure.training.builders.environment instead. "
    ...
    def initialize_ema(self, config) -> None:
        ...
        ``mriforge.models.utils.adaptive_ema``, a module deleted in ff0efff9f —
    ...
    def update_ema(self) -> None:
        ...
        :meth:`~mriforge.config.schemas.ema.EMAConfigSchema.validate_adaptive_ema_is_fully_wired`),
