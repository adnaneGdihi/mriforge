...
from mriforge.core.module_utils import strip_wrapper_prefixes
...
class BaseInferenceStrategy(ABC):
    ...
    def infer(
        ...
        # Postprocess
        final_output = self.postprocess_output(
            raw_output if isinstance(raw_output, torch.Tensor) else raw_output[0],
            **kwargs,
        )
