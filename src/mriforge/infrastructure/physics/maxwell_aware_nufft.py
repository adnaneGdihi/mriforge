...
:class:`~mriforge.infrastructure.physics.concomitant_phase_operator.ConcomitantPhaseOperator`
/ :func:`~mriforge.infrastructure.physics.maxwell_concomitant.maxwell_concomitant_field_hz`)
