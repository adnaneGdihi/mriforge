...
class MaskGenerator:
    ...
    def _generate_sle_kappa(
        ...
        **kwargs,
        ...
        Dispatches to :func:`mriforge.data.transforms.sle_trajectory.build_sle_kspace_mask`.
        ...
        """
        from mriforge.data.transforms.sle_trajectory import build_sle_kspace_mask
...
def _resolve_accelerator_cls(registry_entry: Any, acceleration_type: str) -> type:
    ...
    if cls_ref is None and acceleration_type == "multi_mask":
        from mriforge.models.utils.multi_mask_accelerator import MultiMaskAccelerator
...
class KSpaceAccelerator(ABC):
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        # when the accelerator is built puts it inside `mriforge audit` instead of
    ...
    def _normalized_progress(self, timestep: int) -> float:
        ...
        * ``step`` returns the ratio UNSHAPED because its consumer treats it as a
        ...
        :func:`~mriforge.infrastructure.physics.severity.shape_severity_ratio`
...
class GoldenAngleRadialKSpaceAccelerator(KSpaceAccelerator):
    ...
    #: the same value :data:`mriforge.infrastructure.physics.nufft_ops.GOLDEN_ANGLE`
    #: and :func:`~mriforge.infrastructure.physics.trajectories.TrajectoryFactory.
...
_ACCELERATOR_REGISTRY: dict[str, type[KSpaceAccelerator] | dict[str, Any]] = {
    ...
    "multi_mask": {
        "class": "mriforge.models.utils.multi_mask_accelerator.MultiMaskAccelerator",
        "params": {},
    },
