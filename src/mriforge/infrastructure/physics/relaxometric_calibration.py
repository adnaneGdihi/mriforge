...
in the package (:mod:`mriforge.infrastructure.physics.relaxation_priors`), so
...
def spgr_signal(t1_ms: float, t2_ms: float, acq: AcquisitionParams) -> float:
    ...
    The same expression :class:`~mriforge.infrastructure.physics.differentiable_bloch.DifferentiableBlochLayer`
