...
from mriforge.core.types import CoilSens, Image, KSpace, Mask, Tensor
from mriforge.infrastructure.physics.fft_ops import ifft2c
from mriforge.infrastructure.physics.implementations import (  # noqa: F401  (import for register_operator side effects: fft2d/nufft must be in the registry)
    FFT2DOperator,
    NUFFTOperator,
)
from mriforge.infrastructure.physics.registry import IForwardOperator, create_operator
...
# ``mriforge.models.losses.physics_informed_integration_loss`` 2026-05-14
