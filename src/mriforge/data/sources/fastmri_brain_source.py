...
3. **A box must be a lesion to enter the lesion region.** ``"Possible artifact"`` (505
   ...
   :data:`~mriforge.data.annotations.fastmri_plus_classes.NON_PARENCHYMAL_GROUPS`.
...
from mriforge.data.annotations.fastmri_plus import LesionBox, YOrigin, pooled_lesion_mask
from mriforge.data.annotations.fastmri_plus_classes import LesionGroup, is_poolable
from mriforge.data.annotations.manifest_qc import verify_approval
from mriforge.data.annotations.matched_control import sample_matched_controls
from mriforge.data.io_strategies import FastMRIH5Strategy
from mriforge.data.regions.mask_cache import RegionMaskCache
from mriforge.data.regions.region_registry import REGION_SPECS, RegionTier, region_spec
