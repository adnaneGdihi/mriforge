...
where :mod:`mriforge.infrastructure.orchestration.campaign_evaluator`
...
input range that :mod:`mriforge.infrastructure.io.adapters` applies.
...
def _load_nifti(path: Path) -> torch.Tensor:
    ...
    :func:`mriforge.infrastructure.io.adapters.load_nifti`, which
