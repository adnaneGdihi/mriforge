...
from mriforge.data.builders.torchio_subject_builder import PreprocessedSubjectBuilder
...
class PreprocessedMRIDataset(torch.utils.data.Dataset):
    ...
    def _apply_split(
        ...
        Delegates to :func:`mriforge.data.split_utils.split_index` rather than
...
This loader integrates with the following experiment types in mriforge:
