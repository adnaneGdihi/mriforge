...
:class:`mriforge.config.settings.TrainingSettings` (frozen Pydantic v2). For
...
- :mod:`mriforge.infrastructure.orchestration.ablation_config_generator` —
...
def read_yaml_dict(path: str | Path) -> dict[str, Any]:
    ...
    :meth:`mriforge.config.settings.TrainingSettings.from_yaml`.
