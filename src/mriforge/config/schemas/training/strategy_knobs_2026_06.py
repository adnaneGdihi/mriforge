...
class QSMPipelineTrainingConfigSchema(BaseModel):
    ...
    Read by
    :class:`~mriforge.infrastructure.training.strategies.qsm_pipeline_strategy.QSMPipelineStrategy`.
...
class QSpaceDiffusionTrainingConfigSchema(BaseModel):
    ...
    Read by
    :class:`~mriforge.infrastructure.training.strategies.qspace_diffusion_strategy.QSpaceDiffusionStrategy`.
