...
# ``unittest.mock.patch("mriforge.config.schemas.training.TrainingConfigGAN")``
...
def create_training_config(config_dict: dict[str, Any]) -> BaseTrainingConfigSchema:
    ...
    module so callers can ``mock.patch("mriforge.config.schemas.training.TrainingConfigGAN")``
