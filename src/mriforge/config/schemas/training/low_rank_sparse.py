...
:class:`~mriforge.infrastructure.training.strategies.low_rank_sparse_strategy.LowRankSparseStrategy`.
...
:class:`~mriforge.config.schemas.training.base.TrainingStrategyConfigSchema`
