...
:data:`~mriforge.config.schemas.renames.RENAMES` is the SSOT for retired config
...
#: Attributes :func:`~mriforge.config.schemas.renames.reject_renamed_keys` and
#: :func:`~mriforge.config.schemas.renames.fold_renamed_keys` stamp on the
