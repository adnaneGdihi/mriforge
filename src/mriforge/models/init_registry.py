...
This avoids circular dependencies in mriforge.models.registry by moving the discovery
...
def populate_model_registry(*, force: bool = False) -> None:
    ...
    model_packages = [
        "mriforge.models.geometric",
        "mriforge.models.vae",
        "mriforge.models.discriminators",
        "mriforge.models.generators",
        "mriforge.models.inr",
        "mriforge.models.latent",
        "mriforge.models.reconstruction",
        "mriforge.models.mae",
        "mriforge.models.trellis",
        "mriforge.models.diffusion",
        "mriforge.models.experimental",
        ...
        "mriforge.models.transformer",
        "mriforge.models.encoders",
        ...
        "mriforge.models.gaussian_splatting",
        "mriforge.models.adaptation",
        "mriforge.models.components",
        "mriforge.models.specialized",
        ...
        "mriforge.models.latent_diffusion",
        # VF campaign Phase 2 breakthrough-method model homes.
        "mriforge.models.physics",
        "mriforge.models.navigation",
        "mriforge.models.acquisition",
        ...
        "mriforge.models.edge",
        "mriforge.models.equilibrium",
        "mriforge.models.fingerprinting",
        "mriforge.models.foundation",
        "mriforge.models.generative",
        "mriforge.models.mamba",
        "mriforge.models.motion",
        "mriforge.models.reasoning",
        "mriforge.models.spectral",
        "mriforge.models.synthesis",
        "mriforge.models.topological",
        ...
        "mriforge.models.unrolled",
        "mriforge.models.volumetric",
    ]
    ...
    # Top-level model modules (single files directly under mriforge.models, not
    ...
    for top_level_module in (
        "mriforge.models.model_compression",
        "mriforge.models.latent_input_wrapper",
        "mriforge.models.domain_adaptation",
    ):
        try:
    ...
    try:
        importlib.import_module("mriforge.models._v6_1_registrations")
    except Exception as e:  # pragma: no cover - fail-loud at audit time
        _record_import_failure("mriforge.models._v6_1_registrations", e)

    # NOTE (2026-07-02): the ``import mriforge.models.sota_registry`` step that
    ...
    try:
        from mriforge.models.stubs import register_aliases
    ...
    # OUTSIDE the mriforge tree (a pip-installed plugin or a MRIFORGE_PLUGINS
    # module) fires its decorator and joins MODEL_REGISTRY. Idempotent — see
    # mriforge.plugins.discover_plugins.
    from mriforge.plugins import discover_plugins

    discover_plugins("mriforge.models")
