...
(:mod:`mriforge.infrastructure.physics.dispersion`) at each field to obtain
...
from mriforge.infrastructure.physics.dispersion import dispersion_rates_voxelwise
