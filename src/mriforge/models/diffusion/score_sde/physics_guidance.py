...
from mriforge.infrastructure.physics.interfaces import IPhysicsOperator
from mriforge.models.diffusion.mrf_diph.bloch_dictionary import BlochDictionary
