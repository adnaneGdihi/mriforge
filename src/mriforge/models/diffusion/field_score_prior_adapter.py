...
:class:`~mriforge.models.generators.field_physics_score_unet.FieldPhysicsEmbeddedScoreUNet` is a
reusable prior ``eps_theta(x_t, timesteps, field_strength)`` (keyword args), but
:class:`~mriforge.models.diffusion.posterior_langevin.PosteriorLangevinEnsemble` (and DPS samplers)
