...
# And taken from https://github.com/davidmrau/mixture-of-experts with
# modifications
import torch
...
class SparseDispatcher:
    ...
    def combine(self, expert_out, conv_dims, multiply_by_gates=True):
        ...
        if multiply_by_gates:
            _nonzero_gates = self._nonzero_gates.view(
                self._nonzero_gates.shape + _conv_dims,
            )
            stitched = stitched.mul(_nonzero_gates.to(stitched.dtype))
