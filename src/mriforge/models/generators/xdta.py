...
* :class:`mriforge.models.blocks.sfc_windowed_attention.CrossDomainBlock` —
  the building block.
* :class:`mriforge.models.blocks.hilbert_order.HilbertOrder` — Hilbert
  permutation.
"""
...
from mriforge.models.blocks.sfc_windowed_attention import CrossDomainBlock
from mriforge.models.layers.complex_layers import ComplexLinear
