...
:class:`mriforge.models.blocks.fno_block.SpectralConv2d`), so by discretization-
...
(:class:`mriforge.models.losses.physics_anchor_loss.PhysicsAnchorLoss`); as the
...
from mriforge.models.blocks.fno_block import SpectralConv2d
