...
class DynamicGraphUNet(nn.Module):
    ...
    def knn_graph(self, x: torch.Tensor, k: int) -> torch.Tensor:
        """Helper for KNN construction, shared logic possible."""
        # This was defined as standalone function in file or could be imported
        # For now assume external or user provided adj in forward wrapper
        pass
