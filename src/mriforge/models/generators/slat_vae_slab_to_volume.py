...
* :class:`mriforge.models.trellis.sparse_structure_flow.SparseStructureFlowModel`
  is the dense-cubic-voxel diffusion model used as the stage-2 LDM in
  TRELLIS — refines the SLAT in latent space.
* :mod:`mriforge.models.representations.slat.interfaces` defines the
  :class:`ISLATEcoder`/:class:`ISLATDecoder` Protocols and
  :class:`SLATConfig`; :mod:`mriforge.models.representations.slat.renderers`
...
* :mod:`mriforge.models.generators.trellis_structured_vae` — the
  shape-domain SLAT VAE wrapper.
* :mod:`mriforge.models.representations.slat` — SLAT interfaces and
  renderers.
"""
...
from mriforge.models.representations.slat.interfaces import SLATConfig
...
class SLATVAESlabToVolumeConfig:
    ...
    :class:`mriforge.models.representations.slat.interfaces.SLATConfig` is
