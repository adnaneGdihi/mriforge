...
mirrors :mod:`mriforge.models.generators.breakthrough_attention_generators`:
...
from mriforge.models.blocks.heisenberg_conv import HeisenbergConv2d
from mriforge.models.blocks.hyperbolic_layer import PoincareLayer, log_map_zero
