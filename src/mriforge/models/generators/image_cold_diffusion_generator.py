...
from mriforge.models.diffusion.architectures.image_cold_diffusion_unet import (
    ImageColdDiffusionUNet,
)
from mriforge.models.generators.mixins.diffusion import DiffusionMixin
...
class ImageColdDiffusionGenerator(nn.Module, DiffusionMixin, IGenerator):
    ...
    def _predict_start_from_noise(self, x_t: Tensor, t: Tensor, noise: Tensor) -> Tensor:
        # Not used in Cold Diffusion. We predict x_0 directly.
        pass

    def _model_forward(self, x: Tensor, t: Tensor, **kwargs: Any) -> Tensor:
        # Not used directly in our subclass overrides.
        pass
