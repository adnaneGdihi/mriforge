...
for all available generator model types in the MRIForge framework. Using these constants
instead of magic strings improves code maintainability, enables IDE autocomplete,
and reduces the likelihood of typos.

Usage:
    from mriforge.models.factories.generator_types import GeneratorTypes
...
class GeneratorTypes:
    """Registry of all available generator model types in MRIForge.
