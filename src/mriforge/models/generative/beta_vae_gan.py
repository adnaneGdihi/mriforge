...
:class:`mriforge.models.losses.beta_tc_vae_loss.BetaTCVAELoss`; the
discriminator is the existing
:class:`mriforge.models.discriminators.patchgan_discriminator.PatchGANDiscriminator`.
...
from mriforge.models.discriminators.patchgan_discriminator import PatchGANDiscriminator
from mriforge.models.losses.beta_tc_vae_loss import BetaTCVAELoss
