...
``ν = m·R_L(mν/σ²)`` (see
:mod:`mriforge.infrastructure.physics.ncchi_data_consistency`). This is the exact
``L``-coil generalisation of the moment-based
:class:`~mriforge.models.losses.rician_consistency_loss.RicianConsistencyLoss`
