...
:class:`mriforge.data.transforms.dwi_metadata.LoadDWIMetadata`, which previously
had no consumer (an inert facade — audit finding F3).

The physics itself lives in
:mod:`mriforge.infrastructure.physics.signal_models.diffusion_models` (canonical
...
from mriforge.infrastructure.physics.signal_models.diffusion_models import (
    fit_adc_loglinear,
)
