...
def _rect_hilbert_2d_indices(h: int, w: int) -> np.ndarray:
    ...
    Used by :class:`~mriforge.models.generators.cs_mno_operator.CSMNOOperator`
...
def _morton_2d_indices(h: int, w: int) -> np.ndarray:
    ...
    from mriforge.models.blocks.morton_stem import compute_morton_2d
...
def _morton_3d_indices(d: int, h: int, w: int) -> np.ndarray:
    ...
    from mriforge.models.blocks.morton_stem import compute_morton_3d
...
def _radial_inside_out(h: int, w: int) -> np.ndarray:
    ...
    from mriforge.models.blocks.radial_linearizer import radial_inside_out_indices
...
def _radial_outside_in(h: int, w: int) -> np.ndarray:
    ...
    from mriforge.models.blocks.radial_linearizer import radial_outside_in_indices
