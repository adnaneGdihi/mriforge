...
All FFT operations route through `mriforge.infrastructure.physics.fft_ops` to
...
``mriforge.models.blocks.attention_domains`` (the SSOT) and
...
# ``mriforge.models.blocks.attention_domains`` (the feature-domain SSOT) on
