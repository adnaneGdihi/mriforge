...
- :class:`~mriforge.models.blocks.equivariant.group_conv.GroupConv2d`
- :class:`~mriforge.models.blocks.equivariant.group_actnorm.GroupActNorm2d`
- :class:`~mriforge.models.blocks.equivariant.group_coupling.GroupCoupling`
