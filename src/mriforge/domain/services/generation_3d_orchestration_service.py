...
.. warning::
   ...
   **DORMANT (2026-06-12).** This service is not wired into any live
   ...
   :mod:`mriforge.models.pipelines.generation_pipeline`, is broken dead code
...
from mriforge.domain.entities.entities_3d import SLAT, Gaussian3D, Mesh, MRIVolume

try:  # pragma: no cover - optional dependency
    from mriforge.models.pipelines import generation_pipeline as generation_pipeline_module
except ImportError:  # pragma: no cover - optional dependency
    generation_pipeline_module = None

from mriforge.domain.interfaces.infrastructure_interfaces import (
    IDevicePolicy,
...
from mriforge.infrastructure.services.device_policy import create_auto_device_policy
