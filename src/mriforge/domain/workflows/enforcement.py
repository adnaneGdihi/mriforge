...
The :class:`~mriforge.config.schemas.enums.Maturity` on a
:class:`~mriforge.domain.workflows.profiles.WorkflowProfile` is a *promise*
...
from mriforge.domain.workflows.declaration import declared_regime
