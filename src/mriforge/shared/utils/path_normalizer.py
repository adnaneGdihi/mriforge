...
class PathNormalizer:
    ...
    def get_project_root() -> Path:
        ...
        Returns the value of MRIFORGE_ROOT environment variable if set,
        otherwise returns the current working directory.

        Returns:
            Path to project root directory
        """
        env_root = os.environ.get("MRIFORGE_ROOT")
        if env_root:
    ...
    def normalize_and_validate(
        ...
        Args:
            ...
            root_dir: Root directory for relative path resolution.
                     Defaults to project root (from MRIFORGE_ROOT env var or cwd).
        ...
        # locally. Override via MRIFORGE_LEGACY_CLUSTER_PREFIX (e.g. set to
        # "/scratch/me/mriforge/" for your own cluster). Empty string disables.
        cluster_prefix = os.environ.get("MRIFORGE_LEGACY_CLUSTER_PREFIX", "")
