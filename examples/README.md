...
| [quickstart_diffusion.py](quickstart_diffusion.py) | Generate one α-stable Lévy noise step from `spectramr.models.diffusion` and confirm the heavy-tailed kurtosis signature. |
...
`SPECTRAMR_SUPPRESS_CLINICAL_WARNING=1` in batch jobs.
